...
list.files("SI_Figure_X_to_Y_ITC_figures")

ggsave("SI_Figure_X_to_Y_ITC_figures/SI_figure_X_EDTA.svg", SI_figure_X)
...
ggsave("SI_Figure_X_to_Y_ITC_figures/SI_figure_X_plus_1_ATP.svg", SI_figure_X_plus_1)
...
ggsave("SI_Figure_X_to_Y_ITC_figures/SI_figure_Y_Glucose_6P.svg", SI_figure_Y)
